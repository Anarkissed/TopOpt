...
// The S3 geometry instruments now live in a shared header so this probe and
// the cut-population probe are judged by the same code (task 2026-08-08).
// `using namespace topopt::surface_instruments` is at file scope below the
// include, so every use site in this file is unchanged.
