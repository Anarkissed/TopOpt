// lattice_material_probe.cpp — task 2026-08-13-lattice-as-a-material.
//
...
int main(int argc, char** argv) {
  ...
  if (argc < 5) {
    std::printf(
        "usage: lattice_material_probe <part.step> <materials.json> "
  ...
  std::printf("== lattice_material_probe — a frozen region as a MATERIAL ==\n\n");
  ...
  // THE CERTIFICATION POSTURE, isolated exactly as production isolates it.
