...
struct RunInfo {
  ...
  // ★ §1(e2) the dangling-end trim
  long long organic_dangling_ends_trimmed = 0;
  long long organic_curves_dropped_dangling = 0;
  double organic_dangling_length_removed_mm = 0.0;
  long long organic_dangling_rounds = 0;
  long long organic_free_ends = 0;
  double organic_free_end_length_mm = 0.0;
  long long organic_free_ends_before_tie = 0;
  long long organic_ties_added = 0;
  double organic_tie_length_mm = 0.0;
  long long organic_free_ends_unresolved = 0;
  long long organic_pruned_spans = 0;
  double organic_pruned_length_mm = 0.0;
  long long organic_prune_rounds = 0;
  long long organic_plate_contacts = 0;
  long long organic_net_skin_landings = 0;
  long long organic_net_skin_members = 0;
  double organic_net_skin_length_mm = 0.0;
  long long organic_net_skin_landings_joined = 0;
  long long organic_net_skin_fallback_members = 0;
  long long organic_net_skin_edge_landings = 0;
  long long organic_stranded_components_dropped = 0;
  long long organic_stranded_spans_dropped = 0;
  double organic_stranded_length_dropped_mm = 0.0;
