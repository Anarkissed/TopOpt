...
| `maintainer_branch_before_roles_fix.log` | his job on this branch BEFORE the §3 cell-predicate fix — kept because it is where the 97 / 39 `strut_and_solid` divergence was measured |
| `maintainer_final.log` | his job on the final branch |
