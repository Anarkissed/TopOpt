...
- 18:00: his eight pane items applied (Fit/Auto by simulation, grade entry with a simulation, single size without, "Manual" density, shape-fit locked on without a simulation, Unloaded walls hidden without one, all captions ≤ 4 words with the text behind (i)). The next dylib photographs the pane with the simulation off and on.
- Simulator, dylib e7756c0a7b523a88 (21:32): v12_A_pane_sim_on.png (Auto | Manual, Density Auto | Sim | Manual, captions ≤ 4 words), v12_B_manual_grade_entry.png ("Grade · 3.00 mm to 5.00 mm"), v12_C_grade_refused_red_star.png (20 typed, Done ⇒ red * and two reasons), v12_D_pane_sim_off_defects.png (Fit | Manual, Unloaded walls gone, shape fit locked with "Always on: no simulation"; two defects: Size 0.00 mm and stale reasons — fixed), v12_E_shape_fit_locked_notice.png (the pop-up "Shape fit only stays on").
- Simulator, dylib 01ed7776c343430e (21:43): v13_A_grade_pills_centred.png (pills centred); v13_B_grade_inverted_star_no_popup.png — an inverted grade (3 to 1) raised the red * but no pop-up; that path now raises the pop-up too (next dylib).
- Simulator, dylib a19980c907cc0d94 (21:49): v13_C_grade_refused_popup.png — 5 → 1 typed, Done ⇒ the pop-up "3–1 mm is not a lattice here · The upper size must be larger than the lower." with the red * beside the field; no inline red text. His project.json restored (sha d6d1d335024d418e); the app was terminated first.
